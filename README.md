...
**metaMDGB** a **myloasm** na datech z mikrobiálního společenstva
...
![](report_files/figure-commonmark/correlation-1.png)
...
ggplot(mags_df, aes(x = Completeness, y = Contamination)) +
  ...
  # Hranice pro High quality (90% completeness, 5% contamination)
  geom_vline(xintercept = 90, linetype = "dotted") +
  geom_hline(yintercept = 5, linetype = "dotted") +
  # Hranice pro Medium quality (50% completeness, 10% contamination)
...
![](report_files/figure-commonmark/MAGs-1.png)
...
![](report_files/figure-commonmark/MAGs-2.png)
...
2.  Kvalita MAGs: Z hlediska kvality byl assembler **myloasm**
